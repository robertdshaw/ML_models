...
image: "/posts/Stock_Market.jpg"
tags: [Customer Segmentation, Python, K-means Clustering, Hierarchical Clustering, PCA Vizualization]
---

In this project we use k-means clustering to to pick out the best stocks from a list of companies on the NYSE 

segment up the customer base in order to increase business understanding, and to enhance the relevancy of targeted messaging & customer communications.

   
#### This helps investors better analyze stocks across different market segments and help protect against risks that could make the portfolio vulnerable to losses.
